...
static ConfigEntry<bool> useSpecialPad1(false);
static ConfigEntry<bool> useSpecialPad2(false);
static ConfigEntry<bool> useSpecialPad3(false);
static ConfigEntry<bool> useSpecialPad4(false);
static ConfigEntry<int> specialPadClass1(1);
...
void load(const std::filesystem::path& path, bool is_game_specific) {
    ...
    if (data.contains("Input")) {
        ...
        useSpecialPad1.setFromToml(input, "useSpecialPad1", is_game_specific);
        useSpecialPad2.setFromToml(input, "useSpecialPad2", is_game_specific);
        useSpecialPad3.setFromToml(input, "useSpecialPad3", is_game_specific);
        useSpecialPad4.setFromToml(input, "useSpecialPad4", is_game_specific);
        specialPadClass1.setFromToml(input, "specialPadClass1", is_game_specific);
...
void save(const std::filesystem::path& path, bool is_game_specific) {
    ...
    if (!is_game_specific) {
        ...
        data["Input"]["useSpecialPad1"] = useSpecialPad1.base_value;
        data["Input"]["useSpecialPad2"] = useSpecialPad2.base_value;
        data["Input"]["useSpecialPad3"] = useSpecialPad3.base_value;
        data["Input"]["useSpecialPad4"] = useSpecialPad4.base_value;
        data["Input"]["specialPadClass1"] = specialPadClass1.base_value;
...
void setDefaultValues(bool is_game_specific) {
    ...
    if (!is_game_specific) {
        ...
        // Input
        useSpecialPad1.base_value = false;
        useSpecialPad2.base_value = false;
        useSpecialPad3.base_value = false;
        useSpecialPad4.base_value = false;
        specialPadClass1.base_value = 1;
